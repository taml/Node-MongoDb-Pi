...
cd ~/ && mkdir temp && cd temp && wget https://nodejs.org/dist/latest-v5.x/node-v5.11.1-linux-armv6l.tar.gz;
tar -xzf node-v5.11.1-linux-armv6l.tar.gz;
#Remove the tar after extracing it.
sudo rm node-v5.11.1-linux-armv61.tar.gz;
#This next line will copy Node over to the appropriate folder.
sudo mv node-v5.11.1-linux-armv6l/ /opt/nodejs/;
#This line will remove the nodeJs we downloaded.
sudo rm -R node-v5.11.1-linux-armv6l.tar.gz/* && sudo rmdir node-v5.11.1-linux-armv6l.tar.gz/;
